    ...
    <Section surface={true} id="methodology">
      <Container>
          ...
          {steps.map((step, idx) => {
            ...
            return (
              <ScrollReveal key={idx} delayMs={idx * 60}>
                <div
                  className="p-6 bg-white border border-brand-edge rounded-sm flex flex-col justify-between relative group hover:border-brand-electric/50 transition-all duration-300 card-spatial h-full"
                >
                  <div>
        ...
        <ScrollReveal delayMs={150}>
          <div className="mt-12 p-8 rounded-sm bg-white border border-brand-edge grid grid-cols-1 lg:grid-cols-12 gap-8 items-center card-spatial">
