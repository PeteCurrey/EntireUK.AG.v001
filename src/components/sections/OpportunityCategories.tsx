...
import { Building2, Trees, Factory, Landmark, MapPin } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {categories.map((cat, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group border border-brand-edge rounded-sm p-8 bg-white hover:border-brand-electric/50 hover:shadow-md transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-11 h-11 rounded-sm bg-brand-surface border border-brand-edge flex items-center justify-center text-brand-electric group-hover:bg-brand-electric/10 group-hover:border-brand-electric/30 transition-colors">
                  ...
                  <h3 className="text-xl font-medium text-brand-graphite mb-1">
                    {cat.title}
                  </h3>
                  ...
                  <div className="pt-4 border-t border-brand-edge/60 mb-6">
                ...
                <Link
                  href={cat.targetPath}
                  className="text-xs uppercase tracking-wider text-brand-electric font-medium inline-flex items-center gap-1.5 group-hover:translate-x-1 transition-transform"
                >
                  <span>{cat.cta}</span>
                  <span>&rarr;</span>
                </Link>
          ...
          <div className="border border-brand-edge-dark rounded-sm p-8 bg-brand-graphite text-white flex flex-col justify-between">
            <div>
              <span className="eyebrow eyebrow-dark mb-4">Acquisition Discipline</span>
            ...
            <div className="pt-6 border-t border-white/[0.08]">
              <Link
                href="/submit"
                className="text-xs uppercase tracking-wider text-white font-medium inline-flex items-center gap-1.5 hover:text-brand-electric transition-colors"
              >
