      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {valuationDrivers.map((driver, idx) => (
            <div
              key={idx}
              className="p-8 bg-white border border-brand-edge rounded-sm hover:border-brand-electric/40 transition-all duration-300"
            >
        ...
        <div className="mt-12 p-6 sm:p-8 rounded-sm bg-white border border-brand-edge flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
